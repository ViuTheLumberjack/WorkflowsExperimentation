...
TEST_SERVICE = 'B'
TEST_TYPE = f'service_{TEST_SERVICE}'

TEST_PATH = os.path.join(os.path.dirname(__file__), f'configurations/test_{TEST_TYPE}.jmx')
OUPUT_PATH = os.path.join(os.path.dirname(__file__), f'results/{TEST_TYPE}/results_{NUM_CORES}core.csv')
LOG_PATH = os.path.join(os.path.dirname(__file__), 'results/output.log')
PLOT_PATH = os.path.join(os.path.dirname(__file__), f'results/{TEST_TYPE}/plots/response_time_{NUM_CORES}cores_50.pdf')
